...
export const RESUME_DATA = {
  ...
  contact: {
    ...
    social: [
      {
        name: "GitHub",
        url: "https://github.com/geekqq",
        icon: GitHubIcon,
      },
      {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/stonehoo/",
        icon: LinkedInIcon,
      },
      {
        name: "X",
        url: "https://x.com/stonehoo",
        icon: XIcon,
      },
    ],
  },
  education: [
    {
      school: "Zhejiang Jiaxing University",
      degree: "Bachelor's Degree in Business and English",
      start: "2003",
      end: "2007",
    },
  ],
